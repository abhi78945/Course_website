...
<body>
    ...
    <section class="course-details">
        ...
        <p>Cybersecurity covers various aspects of safeguarding digital systems, networks, and data from unauthorized access, attacks, and breaches.</p>
        ...
        <div class="course-video">
            ...
            <div class="video-details">
                <div class="description">
                    <h3>Description</h3>
                    <p>A cybersecurity course provides comprehensive instruction on safeguarding digital systems, networks, and data against cyber threats and attacks. Covering diverse areas such as network security, encryption, risk assessment, incident response, and ethical hacking, the course equips learners with the knowledge and skills necessary to identify vulnerabilities, implement protective measures, and respond effectively to security incidents. Through hands-on labs, real-world simulations, and case studies, students gain practical experience in threat detection.</p>
            ...
            <div class="sample-certificate">
                ...
                <a href="cscertificate.html" target="_blank" class="btn-sample-certificate">Sample Certificate</a>
