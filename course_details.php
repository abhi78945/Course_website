        ...
        <div class="course-video">
            ...
            <div class="video-details">
                <div class="description">
                    <h3>Description</h3>
                    <p>A frontend development course typically covers the foundational skills and technologies necessary to create the user interface and user experience of websites and web applications. Here's a general description of what you might expect from a frontend development course:</p>
